...
// taken from https://github.com/CSFrequency/react-firebase-hooks/blob/master/util/useLoadingValue.ts
// see Apache 2.0 License https://github.com/CSFrequency/react-firebase-hooks/blob/master/LICENSE
...
export const useLoadingValue = <T, E>(
  ...
  const reset = useCallback(() => {
    const defaultValueReset = getDefaultValue ? getDefaultValue() : undefined;
    dispatch({type: 'reset', defaultValue: defaultValueReset});
  }, [getDefaultValue]);
